...
public class ResponseFormat {
	...
	/*private static Map<Integer,String> messageMap = Maps.newConcurrentMap();
    ...
    public static GenericResponse error(Integer status, String message) {
        GenericResponse json = new GenericResponse(status, message, null);
        return json;
    }
    
    
    public static GenericResponse sucess(Object object) {
    	GenericResponse genericResponse = new GenericResponse(ExceptionCodeEnum.SUCESS.getCode(), ExceptionCodeEnum.SUCESS.getMessage(), object);
    	return genericResponse;
    }
    
    
    public static GenericResponse sucess() {
    	return sucess(null);
    }
}
